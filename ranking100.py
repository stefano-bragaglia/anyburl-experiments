...
train = f"data/hetionet-v1.0-train.tsv"
# when loading from disk set to "" to not use additional filter
#filter_set = f"valid.tsv"
target = f"data/hetionet-v1.0-test-treats.tsv"

rules = f"data/anyburl-rules.txt"

filter_set = f"data/hetionet-v1.0-train.tsv"

out = f"data/ranking-file-100.txt"
